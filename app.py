...
with st.form("input_form"):
    ...
    minimum_return = st.number_input("📉 Minimum Acceptable Return (%)", min_value=0.0, max_value=100.0, value=9.0)
    ...
    if not uploaded_file:
        ...
        if uploaded_file.name.endswith(".pdf"):
            try:
                ...
                try:
                    benchmark_df = pd.read_csv("Wealth_Analyzer_Benchmarks.csv")
